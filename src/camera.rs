...
pub fn setup_camera(
    ...
    commands.spawn((
        Camera2dBundle {
            ...
            camera_2d: Camera2d { clear_color: ClearColorConfig::Custom(Color::rgb(174.0/255.0, 111.0/255.0, 86.0/255.0))},
            ..default()
        },
        CameraMarker {
            zoom_speed:1.02,
...
//             &mut Transform,
//         ),
//         (Without<PlayerMarker>, With<CameraMarker>),
//     >,    
//     ldtk_projects: Query<&Handle<LdtkAsset>>,
...
// ) {
//     for (_, level_iid) in &level_query {
//         for project in ldtk_project_assets.get(ldtk_projects.single()).iter() {
//             // println!("{:?}", level_iid.iids);
//             // println!("{:?}", );
//             let level = project.tileset_map; // .get_level(&LevelSelection::Iid(format!("{:?}", level_iid.iids)));
//         }
//     }
// }